...
export function Footer({ isDarkMode }: Props) {
  return (
    <div className="w-screen flex justify-center" id="footer">
      <div className="w-full flex flex-col items-center bottom-0">
        ...
        <div className="mt-60 flex flex-col justify-center bg-violet-100 backdrop-blur-lg w-full">
          <div className="flex mt-8 gap-5 justify-center">
            <a href="https://www.instagram.com/kelson_vict0r/" target="_blank">
              <Image
                src={instagram}
                alt="Instagram Logo"
            ...
            <a href="https://github.com/K3lOli" target="_blank">
              <Image
                src={github}
                alt="Instagram Logo"
                className="w-7 transition-all duration-300 hover:scale-125"
            ...
            <a
              href="https://www.linkedin.com/in/kelson-victor/"
              target="_blank"
            >
              <Image
                src={linkedin}
          ...
          <p className="mt-4 mb-6 text-center">
            © 2023 Kelson Victor. All rights reserved.
          </p>
        </div>
      </div>
    </div>
